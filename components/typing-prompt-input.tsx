...
export default function TypingPromptInput() {
  const prompts = [
    "Integrate DeFi lending protocols with our enterprise treasury management...",
    "Calculate optimal yield farming strategies across multiple chains...",
    "Automate trade finance workflows using smart contracts...",
    "Connect our B2B marketplace to global liquidity pools...",
    "Generate compliance reports for cross-border DeFi transactions...",
    "Analyze credit risk using on-chain data and AI models...",
    "Set up multi-sig wallets for institutional DeFi access...",
    "Monitor real-time DeFi positions across all protocols...",
  ]
